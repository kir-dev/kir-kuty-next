...
import {httpStatusNames, httpStatusCodes} from "@/app/games/http/httpConsts";
...
export default function HttpGame() {
    ...
    const [answers, setAnswers] = useState<Answers>({strings: [""], correctBtnIndex: 0, correctHttpCode:0});
